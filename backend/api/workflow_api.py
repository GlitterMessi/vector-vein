...
class WorkflowAPI(APIRouter):
    ...
    def __init__(self):
        ...
        def add_to_fast_access( payload:dict):
            status, msg, workflow = get_user_object_general(
                Workflow,
                wid=payload.get("wid", None),
            )
        ...
        def delete_from_fast_access( payload:dict):
            status, msg, workflow = get_user_object_general(
                Workflow,
                wid=payload.get("wid", None),
            )
...
class WorkflowTemplateAPI(APIRouter):
...
class WorkflowRunRecordAPI(APIRouter):
...
class WorkflowTagAPI(APIRouter):
    name = "workflow_tag"
...
# TODO: Implement this
class WorkflowRunScheduleAPI(APIRouter):
